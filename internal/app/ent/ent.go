...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			firstlogin.Table:         firstlogin.ValidColumn,
			loginattempts.Table:      loginattempts.ValidColumn,
			password.Table:           password.ValidColumn,
			permission.Table:         permission.ValidColumn,
			phone.Table:              phone.ValidColumn,
			role.Table:               role.ValidColumn,
			rolehaspermissions.Table: rolehaspermissions.ValidColumn,
			services.Table:           services.ValidColumn,
			user.Table:               user.ValidColumn,
			userhasroles.Table:       userhasroles.ValidColumn,
		})
	})
