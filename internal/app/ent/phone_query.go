...
func (pq *PhoneQuery) QueryUser() *UserQuery {
...
func (pq *PhoneQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (pq *PhoneQuery) WithUser(opts ...func(*UserQuery)) *PhoneQuery {
	query := (&UserClient{config: pq.config}).Query()
...
func (pq *PhoneQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Phone, error) {
	...
	if query := pq.withUser; query != nil {
		if err := pq.loadUser(ctx, query, nodes, nil,
			func(n *Phone, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PhoneQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Phone, init func(*Phone), assign func(*Phone, *User)) error {
...
func (pq *PhoneQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := pq.ctx.Fields; len(fields) > 0 {
		...
		if pq.withUser != nil {
			_spec.Node.AddColumnOnce(phone.FieldUserID)
		}
	}
