...
type UserQuery struct {
	...
	withBan           *BanQuery
	withFirstLogin    *FirstLoginQuery
	withLoginAttempts *LoginAttemptsQuery
	withRoles         *RoleQuery
	withUserHasRoles  *UserHasRolesQuery
...
func (uq *UserQuery) QueryPhones() *PhoneQuery {
	query := (&PhoneClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryBan chains the current query on the "ban" edge.
func (uq *UserQuery) QueryBan() *BanQuery {
	query := (&BanClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryFirstLogin chains the current query on the "first_login" edge.
func (uq *UserQuery) QueryFirstLogin() *FirstLoginQuery {
	query := (&FirstLoginClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryLoginAttempts chains the current query on the "login_attempts" edge.
func (uq *UserQuery) QueryLoginAttempts() *LoginAttemptsQuery {
	query := (&LoginAttemptsClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryUserHasRoles chains the current query on the "user_has_roles" edge.
func (uq *UserQuery) QueryUserHasRoles() *UserHasRolesQuery {
	query := (&UserHasRolesClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withPhones:        uq.withPhones.Clone(),
		withBan:           uq.withBan.Clone(),
		withFirstLogin:    uq.withFirstLogin.Clone(),
		withLoginAttempts: uq.withLoginAttempts.Clone(),
		withRoles:         uq.withRoles.Clone(),
		withUserHasRoles:  uq.withUserHasRoles.Clone(),
...
func (uq *UserQuery) WithPhones(opts ...func(*PhoneQuery)) *UserQuery {
	query := (&PhoneClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithBan tells the query-builder to eager-load the nodes that are connected to
// the "ban" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithBan(opts ...func(*BanQuery)) *UserQuery {
	query := (&BanClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithFirstLogin tells the query-builder to eager-load the nodes that are connected to
// the "first_login" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithFirstLogin(opts ...func(*FirstLoginQuery)) *UserQuery {
	query := (&FirstLoginClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withFirstLogin = query
	return uq
}

// WithLoginAttempts tells the query-builder to eager-load the nodes that are connected to
// the "login_attempts" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithLoginAttempts(opts ...func(*LoginAttemptsQuery)) *UserQuery {
	query := (&LoginAttemptsClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithUserHasRoles tells the query-builder to eager-load the nodes that are connected to
// the "user_has_roles" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithUserHasRoles(opts ...func(*UserHasRolesQuery)) *UserQuery {
	query := (&UserHasRolesClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withUserHasRoles = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [8]bool{
			...
			uq.withPhones != nil,
			uq.withBan != nil,
			uq.withFirstLogin != nil,
			uq.withLoginAttempts != nil,
			uq.withRoles != nil,
			uq.withUserHasRoles != nil,
		}
	)
	...
	if query := uq.withPhones; query != nil {
		if err := uq.loadPhones(ctx, query, nodes,
			func(n *User) { n.Edges.Phones = []*Phone{} },
			func(n *User, e *Phone) { n.Edges.Phones = append(n.Edges.Phones, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withBan; query != nil {
		if err := uq.loadBan(ctx, query, nodes,
			func(n *User) { n.Edges.Ban = []*Ban{} },
			func(n *User, e *Ban) { n.Edges.Ban = append(n.Edges.Ban, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withFirstLogin; query != nil {
		if err := uq.loadFirstLogin(ctx, query, nodes,
			func(n *User) { n.Edges.FirstLogin = []*FirstLogin{} },
			func(n *User, e *FirstLogin) { n.Edges.FirstLogin = append(n.Edges.FirstLogin, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withLoginAttempts; query != nil {
		if err := uq.loadLoginAttempts(ctx, query, nodes,
			func(n *User) { n.Edges.LoginAttempts = []*LoginAttempts{} },
			func(n *User, e *LoginAttempts) { n.Edges.LoginAttempts = append(n.Edges.LoginAttempts, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := uq.withUserHasRoles; query != nil {
		if err := uq.loadUserHasRoles(ctx, query, nodes,
			func(n *User) { n.Edges.UserHasRoles = []*UserHasRoles{} },
			func(n *User, e *UserHasRoles) { n.Edges.UserHasRoles = append(n.Edges.UserHasRoles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadPasswords(ctx context.Context, query *PasswordQuery, nodes []*User, init func(*User), assign func(*User, *Password)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(password.FieldUserID)
	}
...
func (uq *UserQuery) loadPhones(ctx context.Context, query *PhoneQuery, nodes []*User, init func(*User), assign func(*User, *Phone)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(phone.FieldUserID)
	}
...
func (uq *UserQuery) loadBan(ctx context.Context, query *BanQuery, nodes []*User, init func(*User), assign func(*User, *Ban)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ban.FieldUserID)
	}
	query.Where(predicate.Ban(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.BanColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadFirstLogin(ctx context.Context, query *FirstLoginQuery, nodes []*User, init func(*User), assign func(*User, *FirstLogin)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(firstlogin.FieldUserID)
	}
	query.Where(predicate.FirstLogin(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.FirstLoginColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadLoginAttempts(ctx context.Context, query *LoginAttemptsQuery, nodes []*User, init func(*User), assign func(*User, *LoginAttempts)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(loginattempts.FieldUserID)
	}
	query.Where(predicate.LoginAttempts(func(s *sql.Selector) {
...
func (uq *UserQuery) loadUserHasRoles(ctx context.Context, query *UserHasRolesQuery, nodes []*User, init func(*User), assign func(*User, *UserHasRoles)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userhasroles.FieldUserID)
	}
	query.Where(predicate.UserHasRoles(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.UserHasRolesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
